...
constexpr uint32_t kSimpleFocStatusIntervalMs = 1000;
constexpr bool kSimpleFocLogHallChanges = false;
constexpr bool kSimpleFocOpenloopPeriodicLog = false;
constexpr bool kSimpleFocOpenloopPeriodicSpiRead = false;
constexpr bool kSimpleFocClosedloopPeriodicLog = false;
constexpr bool kSimpleFocClosedloopPeriodicSpiRead = false;
constexpr float kSimpleFocClosedloopTargetRpm = 120.0f;
constexpr float kSimpleFocClosedloopVoltageLimit = 0.60f;
...
constexpr uint32_t kSimpleFocClosedloopHallWatchdogMs = 600;
...
constexpr float kSimpleFocClosedloopStartupRpm = 160.0f;
constexpr float kSimpleFocClosedloopStartupVoltageLimit = 1.90f;
...
constexpr float kSimpleFocOpenloopTargetRpm = 120.0f;
constexpr float kSimpleFocOpenloopVoltageLimit = 0.60f;
